      ...
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        <button class="c-header-toggler c-class-toggler d-lg-none mr-auto" type="button" data-target="#sidebar" data-class="c-sidebar-show"><span class="c-header-toggler-icon"></span></button>
          <a class="c-header-brand d-sm-none" href="#">
            <img class="c-header-brand-full c-d-dark-none" src="{{ url('/assets/brand/coreui-pro.svg') }}" width="118" height="46" alt="CoreUI Logo">
            ...
            <img class="c-header-brand-full c-d-light-none" src="{{ url('/assets/brand/coreui-pro-white.svg') }}" width="118" height="46" alt="CoreUI Logo">
