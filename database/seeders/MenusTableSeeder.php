...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        $id = $this->insertLink('user,admin', 'Colors', '/colors', 'cil-color-palette');
        ...
        $this->addTranslation('ru', 'Приложения', $id);
        $id = $this->insertLink('user,admin', 'Invoicing', '/apps/invoicing');
        $this->addTranslation('pl', 'Faktury', $id);
        $this->addTranslation('ru', 'Счета', $id);
        $id = $this->insertLink('user,admin', 'Invoice', '/apps/invoicing/invoice');
        $this->addTranslation('pl', 'Faktura', $id);
        $this->addTranslation('ru', 'Счет', $id);
        $id = $this->insertLink('user,admin', 'Email', '/apps/email');
        $this->addTranslation('pl', 'E-mail', $id);
        $this->addTranslation('ru', 'Электронная почта', $id);
        $id = $this->insertLink('user,admin', 'Messages', '/apps/messages');
        $this->addTranslation('pl', 'Wiadomości', $id);
        $this->addTranslation('ru', 'Сообщения', $id);
        $id = $this->insertLink('user,admin', 'Social', '/apps/social');
        $this->addTranslation('pl', 'Społeczność', $id);
        $this->addTranslation('ru', 'Социальность', $id);
        $this->endDropdown();
        $this->endDropdown();
        ...
        $this->addTranslation('pl', 'Role', $id);
        $this->addTranslation('ru', 'Роли', $id);
        $id = $this->insertLink('admin', 'Permissions', '/permissions');
        $this->addTranslation('pl', 'Uprawnienia', $id);
        $this->addTranslation('ru', 'Права', $id);
        $id = $this->insertLink('admin', 'Languages', '/languages');
        $this->addTranslation('pl', 'Języki', $id);
        $this->addTranslation('ru', 'Языки', $id);
        $id = $this->insertLink('admin', 'Translations', '/translations');
        $this->addTranslation('pl', 'Tłumaczenia', $id);
        $this->addTranslation('ru', 'Переводы', $id);
        $id = $this->insertLink('admin', 'Menu', '/menu');
        $this->addTranslation('pl', 'Menu', $id);
        $this->addTranslation('ru', 'Меню', $id);

        $id = $this->insertLink('admin', 'Edit menu', '/menu/menu');
        $this->addTranslation('pl', 'Edytuj Menu', $id);
        $this->addTranslation('ru', 'Редактировать меню', $id);
        $id = $this->insertLink('admin', 'Edit menu elements', '/menu/element');
        $this->addTranslation('pl', 'Edytuj elementy menu', $id);
        $this->addTranslation('ru', 'Редактировать элементы меню', $id);
        $id = $this->insertLink('admin', 'Manage Languages', '/languages');
        $this->addTranslation('pl', 'Edytuj języki', $id);
        $this->addTranslation('ru', 'Редактировать языки', $id);
        $id = $this->insertLink('admin', 'Edit roles', '/roles');
        $this->addTranslation('pl', 'Edytuj role', $id);
        $this->addTranslation('ru', 'Редактировать роли', $id);
        $id = $this->insertLink('admin', 'Media', '/media');
        $this->addTranslation('pl', 'Media', $id);
        $this->addTranslation('ru', 'Медиа', $id);
        $id = $this->insertLink('admin', 'BREAD', '/bread');
